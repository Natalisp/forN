...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post data_url, params: { datum: { inventory: @datum.inventory, month: @datum.month, profits: @datum.profits } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { inventory: @datum.inventory, month: @datum.month, profits: @datum.profits } }
